...
| ------ | ------ | ------ |
| [Number of Islands](https://leetcode.com/problems/number-of-islands/)  | Completed | Medium |
| [Partition Labels](https://leetcode.com/problems/partition-labels/) | Completed | Medium |
| [Two Sum](https://leetcode.com/problems/two-sum/) | Completed | Easy |
| [Reorder Data in Log Files](https://leetcode.com/problems/reorder-data-in-log-files/)  | Completed | Medium |
| [LRU Cache](https://leetcode.com/problems/lru-cache/)  | Completed | Medium |
| [Minimum Difficulty of a Job Schedule](https://leetcode.com/problems/minimum-difficulty-of-a-job-schedule/)  | Skipped | Hard |
| [Critical Connections in a Network](https://leetcode.com/problems/critical-connections-in-a-network/) | Skipped | Hard |
| [Pairs of Songs With Total Durations Divisible by 60](https://leetcode.com/problems/pairs-of-songs-with-total-durations-divisible-by-60/)  | Completed | Medium  |
| [K Closest Points to Origin](https://leetcode.com/problems/k-closest-points-to-origin/)  | Completed | Easy |
| [Merge Two Sorted Lists](https://leetcode.com/problems/merge-two-sorted-lists/)  | Comppleted | Easy |
